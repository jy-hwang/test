        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="${pageContext.request.contextPath}/resources/dist/img/corgy1.png" class="user-image" alt="User Image" />
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <img src="${pageContext.request.contextPath}/resources/dist/img/corgy2.png" class="img-circle" alt="User Image" />
                  <p>
                    Jackie Hwang - Web Developer Novice <small>Member since May. 2017</small>
                  </p>
                </li>
                <!-- Menu Body -->
                <li class="user-body">
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="${pageContext.request.contextPath}/resources/dist/img/corgy3.png" class="img-circle" alt="User Image" />
          </div>
