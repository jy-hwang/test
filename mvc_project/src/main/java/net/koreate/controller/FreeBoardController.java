...
public class FreeBoardController {
	...
	public String readFree(@RequestParam("fno") int fno, @ModelAttribute("cri") SearchCriteria cri,
	...
	public String readDetail(@ModelAttribute("fno") int fno, @ModelAttribute("cri") SearchCriteria cri, Model model)
			throws Exception {
	...
	public void modifyGET(@RequestParam("fno") int fno, @ModelAttribute("cri") SearchCriteria cri, Model model)
			throws Exception {
	...
	public String modifyPOST(@RequestParam("fno") int fno, SearchCriteria cri, RedirectAttributes rttr)
			throws Exception {
	...
	public String recommand(@RequestParam("fno") int fno, @ModelAttribute("cri") SearchCriteria cri,
			RedirectAttributes rttr) throws Exception {
		service.recommand(fno);
		rttr.addAttribute("fno", fno);
		rttr.addAttribute("page", cri.getPage());
		rttr.addAttribute("perPageNum", cri.getPerPageNum());
		rttr.addAttribute("searchType", cri.getSearchType());
